...
public class IndexController {
    ...
    public String index(Model model) {
        ...
        //查询新手宝type=0
        List<LoanInfo> xinShouBaoList = loanInfoService.queryPageByType(P2PConstants.PRODUCT_TYPE_XINSHOUBAO_0,0,1);
        //查询优选的type=1
        List<LoanInfo> youXuanList = loanInfoService.queryPageByType(P2PConstants.PRODUCT_TYPE_YOUXUAN_1,0,4);
        //查询散标的type=2
        List<LoanInfo> sanBiaoList = loanInfoService.queryPageByType(P2PConstants.PRODUCT_TYPE_SANBIAO_2,0,8);
